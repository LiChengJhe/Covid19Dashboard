...
@Component({
  ...
  templateUrl: './country-stat-bar-chart.component.html',
  styleUrls: ['./country-stat-bar-chart.component.css']
})
export class CountryStatBarChartComponent implements OnInit, OnChanges {
  @Input() Top: number;
